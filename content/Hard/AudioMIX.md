...
ここで目をつけたのが[GSX1200](https://www.amazon.co.jp/dp/B01LDTP46G/ref=cm_sw_r_tw_dp_U_x_IRLlEbZBWVB7F)に搭載されている「__デイジーチェーン__ 」という機能です。  
こちらの機能、本来はプロゲーマーチームのような横に並んでゲームをする環境で使う機能です。  
ハードワイヤで通話音声を繋げる機能で ネットを介さないのでラグもなく通信不備もなくなるというものです。  

要するに、ハードワイヤで音声をアンプに送るんですよね。  
そこにミキサから出てくる通話音声を入れればいいじゃないですか。  
